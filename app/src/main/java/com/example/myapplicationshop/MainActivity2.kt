...
private val products = listOf(
    Produkt(id=1, name="Франшиза1", price = 5000.0, description = "Пирожные «Наполеон» и «Эстерхази», эклеры с ванильным кремом, макаруны и шоколадные трюфели. Пастельные тона, кружевные скатерти, фарфоровая посуда.", ImageRes =R.drawable.one ),
    Produkt(id=2, name="Франшиза2", price = 8500.0, description = "Тёмное и светлое пиво, крепкие эли, закуски к пиву: сырные палочки, крылья барбекю. Деревянная мебель, приглушённый свет, спортивные трансляции на экранах.", ImageRes =R.drawable.two ),
    Produkt(id=3, name="Франшиза3", price = 6000.0, description = "Здоровые блюда без мяса: смузи‑боулы, салаты с киноа, веганские десерты. Натуральные соки и травяные чаи. Светлое помещение с живыми растениями.", ImageRes =R.drawable.thre ),
    Produkt(id=4, name="Франшиза4", price = 2000.0, description = "Свежайшие суши и роллы от шеф‑повара: филадельфия, калифорния, урамаки. Лёгкие салаты, мисо‑суп и зелёный чай. Минималистичный японский стиль в интерьере.", ImageRes =R.drawable.four ),
    Produkt(id=5, name="Франшиза5", price = 2500.0, description = "Душистый хлеб на закваске, слоёные пирожки, булочки с корицей и маковые рулеты. Всё выпекается утром — запах чувствуется издалека. Доброжелательные продавцы.", ImageRes =R.drawable.five ),
    Produkt(id=6, name="Франшиза6", price = 25600.0, description = "Невероятно сочные бургеры с двойной котлетой, свежими овощами и домашними соусами. Картошка по‑деревенски, ягодные морсы. Светлое пространство с большими окнами и мягкими диванами.", ImageRes =R.drawable.six ),
    Produkt(id=7, name="Франшиза7", price = 5600.0, description = "Сырные бургеры с несколькими видами сыра: чеддер, моцарелла, голубой. Дополнения на выбор: грибы, халапеньо, трюфельный соус. Тёплые тона в интерьере, деревянные столы.", ImageRes =R.drawable.seven ),
    Produkt(id=8, name="Франшиза8", price = 4007.0, description = "Бургеры с мясом, приготовленным на открытом огне. Фирменные сочетания: бекон, сыр бри, карамелизированный лук. Уютные кабинки, приглушённый свет, дружеские посиделки.", ImageRes =R.drawable.eith ),
    Produkt(id=9, name="Франшиза9", price = 6700.0, description = "Сочные бургеры с мраморной говядиной, копчёными рёбрышками и фирменными соусами. Хрустящий картофель, крафтовое пиво. Брутальный интерьер в стиле лофт, открытые кирпичные стены.", ImageRes =R.drawable.nine ),
